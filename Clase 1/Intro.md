...
# 7. Las funciones nos permiten hacer operaciones más complejas:
mean(mi_vector) -> promedio
sd(mi_vector) -> desviacion_estandar
...
?mean
help("mean")
help(package = "stats") # o podemos ver toda la documentación de un paquete
...
# **Tarea 1:** Escriba al frente de cada comando su respectiva descripción
...
# 1. ¿Qué especie tiene los pétalos más grandes en promedio? Escriba el código que usó para llegar a esta respuesta.
# 2. De los individuos que tienen sépalos menores a 5 mm de largo ¿cuántos tienen los sépalos menores a 3.5 mm de ancho? Escriba el código que usó para llegar a esta respuesta.
# 3. ¿Cuantos individuos de Iris setosa tienen los pétalos de 0.2 mm de ancho?
